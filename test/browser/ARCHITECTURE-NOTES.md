...
4. **Document the null-origin constraint** in `docs/design/mraid-bridge-design.md` and `docs/design/safeframe-bridge-design.md` so future implementers understand why the wrapper must be same-origin with the SHARC assets.
